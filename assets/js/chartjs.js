            ...
            return void 0 !== u && (u = n(u), p = a), i.call(l, p, (function(n, i) {
                ...
                switch (i.charAt(0)) {
                    ...
                    default:
                        ...
                        if (c > d) {
                            var l = o(c / 10);
                            return 0 === l ? n : l <= d ? void 0 === s[l - 1] ? i.charAt(1) : s[l - 1] + i.charAt(1) : n
                        }
                        a = s[c - 1]
                }
                return void 0 === a ? "" : a
        ...
        n("replace", 2, (function(t, e, r, n) {
            ...
            return [function(r, n) {
                ...
                for (var E, w = "", L = 0, O = 0; O < S.length; O++) {
                    C = S[O];
                    for (var A = String(C[0]), k = f(d(a(C.index), y.length), 0), T = [], R = 1; R < C.length; R++) T.push(void 0 === (E = C[R]) ? E : String(E));
                    var P = C.groups;
                    if (x) {
